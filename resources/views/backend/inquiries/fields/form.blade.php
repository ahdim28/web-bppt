...
<div class="card mb-4">
    ...
    <form action="{{ route('inquiry.field.store', ['inquiryId' => $data['inquiry']->id]) }}" method="POST">
        @csrf
                        ...
                        <div class="tab-pane fade {{ $lang->iso_codes == config('custom.language.default') ? 'active show' : '' }}" id="{{ $lang->iso_codes }}">
                            <div class="card-body pb-2">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control mb-1 @error('label_'.$lang->iso_codes) is-invalid @enderror" lang="{{ $lang->iso_codes }}" 
                                            name="label_{{ $lang->iso_codes }}" value="{{ old('label_'.$lang->iso_codes) }}" placeholder="Enter title...">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control @error('inp_type') is-invalid @enderror" name="inp_type" value="{{ old('inp_type') }}" placeholder="enter input type...">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-form-label col-sm-2 text-sm-right">ID</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control @error('inp_id') is-invalid @enderror" name="inp_id" value="{{ old('inp_id') }}" placeholder="enter input id...">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-form-label col-sm-2 text-sm-right">Class</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control @error('inp_class') is-invalid @enderror" name="inp_class" value="{{ old('inp_class') }}" placeholder="enter input class...">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-form-label col-sm-2 text-sm-right">Attribute</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control @error('inp_attr') is-invalid @enderror" name="inp_attr" value="{{ old('inp_attr') }}" placeholder="enter input attribute...">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-form-label col-sm-2 text-sm-right">Validation</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control @error('validation') is-invalid @enderror" name="validation" value="{{ old('validation') }}" placeholder="laravel validation">
                                    </div>
                                </div>
                                @endif
                            </div>
