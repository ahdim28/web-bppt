            ...
            <div class="tab-pane fade" id="event">
                <div class="card-body">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                <input type="text" class="datetime-picker form-control @error('start_date') is-invalid @enderror" name="start_date"
                                    value="{{ old('start_date', now()) }}" placeholder="enter start date...">
                                <div class="input-group-append">
                                    <span class="input-group-text"><i class="las la-calendar"></i></span>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                <input type="text" class="datetime-picker form-control @error('end_date') is-invalid @enderror" name="end_date"
                                    value="{{ old('end_date', now()->addDay(3)) }}" placeholder="enter end date...">
                                <div class="input-group-append">
                                    <span class="input-group-text"><i class="las la-calendar"></i></span>
                                </div>
                            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control mb-1" name="location" value="{{ old('location') }}" placeholder="Enter location...">
                        </div>
                    </div>
                </div>
            </div>
