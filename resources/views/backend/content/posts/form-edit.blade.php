...
<div class="card">
    ...
    <form action="{{ route('post.update', ['sectionId' => $data['section']->id, 'id' => $data['post']->id]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="tab-content">
                                ...
                                <div class="tab-pane fade {{ $lang->iso_codes == config('custom.language.default') ? 'active show' : '' }}" id="{{ $lang->iso_codes }}">
                                    <div class="card-body pb-2">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control gen_slug @error('title_'.$lang->iso_codes) is-invalid @enderror" lang="{{ $lang->iso_codes }}" 
                                                    name="title_{{ $lang->iso_codes }}" value="{{ old('title_'.$lang->iso_codes, $data['post']->fieldLang('title', $lang->iso_codes)) }}" placeholder="Enter title...">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control slug_spot @error('slug') is-invalid @enderror" lang="{{ $lang->iso_codes }}" name="slug"
                                                        value="{{ old('slug', $data['post']->slug) }}" placeholder="Enter slug...">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="selectpicker custom-select" name="category_id" data-style="btn-default">
                                                    ...
                                                    @foreach ($data['categories'] as $category)
                                                        <option value="{{ $category->id }}" {{ old('category_id', $data['post']->category_id) == $category->id ? 'selected' : '' }}>{!! $category->fieldLang('name') !!}</option>
                                                    @endforeach
                                                </select>
                                                @error('category_id')
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea class="form-control tiny-mce" name="intro_{{ $lang->iso_codes }}">{!! old('intro_'.$lang->iso_codes, $data['post']->fieldLang('intro', $lang->iso_codes)) !!}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-form-label col-sm-2 text-sm-right">Content</label>
                                            <div class="col-sm-10">
                                                <textarea class="form-control tiny-mce" name="content_{{ $lang->iso_codes }}">{!! old('content_'.$lang->iso_codes, $data['post']->fieldLang('content', $lang->iso_codes)) !!}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="tab-pane fade" id="setting">
                <div class="card-body">
                        ...
                        <div class="col-sm-10">
                            <select class="selectpicker show-tick" name="publish" data-style="btn-default">
                                @foreach (config('custom.label.publish') as $key => $publish)
                                    <option value="{{ $key }}" {{ (old('publish', $data['post']->publish) == ''.$key.'') ? 'selected' : '' }}>
                                        {{ __($publish['title']) }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-10">
                            <label class="switcher switcher-success">
                                <input type="checkbox" class="switcher-input check-parent" name="public" value="1" 
                                    {{ (old('public', $data['post']->public) == 1 ? 'checked' : '') }}>
                        ...
                        <div class="col-md-10">
                            <label class="switcher switcher-success">
                                <input type="checkbox" class="switcher-input check-parent" name="is_detail" value="1" 
                                    {{ (old('is_detail', $data['post']->is_detail) == 1 ? 'checked' : '') }}>
                                <span class="switcher-indicator">
                                  <span class="switcher-yes">
                                    <span class="ion ion-md-checkmark"></span>
                                  </span>
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                <input type="text" class="datetime-picker form-control @error('created_at') is-invalid @enderror" name="created_at"
                                    value="{{ old('created_at', $data['post']->created_at->format('Y-m-d H:i:s')) }}" placeholder="enter publish time...">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                <input type="text" class="form-control" id="image1" aria-label="Image" aria-describedby="button-image" name="cover_file"
                                        value="{{ old('cover_file', $data['post']->cover['file_path']) }}" placeholder="browse cover..." readonly>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                <input type="text" class="form-control" placeholder="title..." name="cover_title" value="{{ old('cover_title', $data['post']->cover['title']) }}">
                                </div>
                                <div class="col-sm-6">
                                <input type="text" class="form-control" placeholder="alt..." name="cover_alt" value="{{ old('cover_alt', $data['post']->cover['alt']) }}">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                <input type="text" class="form-control" id="image2" aria-label="Image2" aria-describedby="button-image2" name="banner_file"
                                        value="{{ old('banner_file', $data['post']->banner['file_path']) }}" placeholder="browse banner..." readonly>
                                <div class="input-group-append" title="browse file">
                                    <span class="input-group-text">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                <input type="text" class="form-control" placeholder="title..." name="banner_title" value="{{ old('banner_title', $data['post']->banner['title']) }}">
                                </div>
                                <div class="col-sm-6">
                                <input type="text" class="form-control" placeholder="alt..." name="banner_alt" value="{{ old('banner_alt', $data['post']->banner['alt']) }}">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-10">
                            <select class="selectpicker show-tick" name="custom_view_id" data-style="btn-default">
                                ...
                                @foreach ($data['template'] as $custom)
                                    <option value="{{ $custom->id }}" {{ (old('custom_view_id', $data['post']->custom_view_id) == $custom->id) ? 'selected' : '' }}>
                                        {{ $custom->name }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control mb-1" name="meta_title" value="{{ old('meta_title', $data['post']->meta_data['title']) }}" placeholder="Enter meta title...">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-form-label col-sm-2 text-sm-right">Meta Description</label>
                        <div class="col-sm-10">
                            <textarea class="form-control mb-1" name="meta_description" placeholder="Separated by comma (,)">{{ old('meta_decsription', $data['post']->meta_data['description']) }}</textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-form-label col-sm-2 text-sm-right">Meta Keywords</label>
                        <div class="col-sm-10">
                            <input class="form-control mb-1" name="meta_keywords" id="bs-tagsinput-2" value="{{ old('meta_keywords', $data['post']->meta_data['keywords']) }}" placeholder="">
                    ...
                    <div class="form-group row">
                        <div class="table-responsive">
                            <table id="user-list" class="table card-table table-striped table-bordered table-hover">
                                ...
                                <tbody id="list-files">
                                    @if ($data['post']->files->count() == 0)
                                    <input type="hidden" name="file_id[]" value="">
                                    @endif
                                    @foreach ($data['post']->files as $file)
                                    <input type="hidden" name="file_id[]" value="{{ $file->id }}">
                                    <tr id="delete-file-{{ $file->id }}">
                                        <td style="width: 250px;">
                                            <label class="col-form-label text-sm-left">File</label>
                                            <input type="text" class="form-control mb-1" value="{{ $file->file }}" readonly>
                                        </td>
                                        <td style="width: 150px;">
                                            <label class="col-form-label text-sm-left">Title</label>
                                            <input type="text" class="form-control mb-1" name="file_title_{{ $file->id }}" value="{{ old('file_title_'.$file->id, $file->caption['title']) }}" placeholder="Enter title...">
                                        </td>
                                        <td style="width: 150px;">
                                            <label class="col-form-label text-sm-right">Description</label>
                                            <textarea class="form-control mb-1" name="file_description_{{ $file->id }}" placeholder="Enter description">{{ old('file_decsription_'.$file->id, $file->caption['description']) }}</textarea>
                                        </td>
                                        <td class="text-center" style="width: 10px;">
                                            <button type="button" class="btn btn-danger icon-btn" data-sectionid="{{ $data['post']->section_id }}" data-id="{{ $file->id }}" id="delete-file"><i class="las la-times"></i></button>
                                        </td>
                                    </tr>
                                    @endforeach
                                    <tr>
            ...
            <div class="tab-pane fade" id="profiles">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="{{ $valP['type'] }}" class="form-control mb-1 @error('profile_'.$valP['name']) is-invalid @enderror" name="profile_{{ $valP['name'] }}" value="{{ old('profile_'.$valP['name'], $data['post']->profile->fields[$valP['name']]) }}" placeholder="Enter {{ $valP['label'] }}...">
            ...
            @if (!empty($data['post']->field_category_id) || Auth::user()->hasRole('super'))
            <div class="tab-pane fade" id="field">
                <div class="card-body">
                        ...
                        <div class="col-sm-10">
                            <select id="field_category" class="selectpicker show-tick" name="field_category_id" data-style="btn-default">
                                ...
                                @foreach ($data['fields'] as $field)
                                    <option value="{{ $field->id }}" {{ $field->id == $data['post']->field_category_id ? 'selected' : '' }}>
                                        {{ $field->name }}
                                    </option>
                                @endforeach
                            </select>
                            @if (!empty($data['post']->field_category_id))    
                            <small>Current Field : <strong><i>{{ $data['post']->field->name }}</i></strong></small>
                            @endif
                        </div>
                    </div>
                    <div id="custom_field">
                    ...
                    @else
                    <input type="hidden" name="field_category_id" value="{{ $data['post']->field_category_id }}">
                    @endrole

                    @if (!empty($data['post']->field_category_id))
                    <div id="current_field">
                        @include('backend.master.fields.input-edit', ['module' => 'post'])
                    </div>
                    @endif
                </div>
            </div>
...
<script>
    $(function()  {
        ...
        $("#add").click(function() {
            ...
            var oldFile = '{{ $data['post']->files->count() }}';
            var maxNum = 19 - parseInt(oldFile);
    ...
    $(document).on('click', '#delete-file', function() {
        ...
        var id = $(this).attr("data-id");
        $.ajax({
            url : '/admin/section/'+ section_id +'/post/'+ id + '/file',
            method: 'DELETE',
            success:function() {
