                ...
                <h5 class="mb-2">
                    <div class="float-right dropdown ml-3">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            @can ('photos')
                            <a href="{{ route('gallery.album.photo.index', ['albumId' => $item->id]) }}" class="dropdown-item" title="Photo">
                                <i class="las la-image"></i><span>Photo</span>
                            </a>
                            @endcan
                            <a href="{{ route('gallery.album.edit', ['id' => $item->id]) }}" class="dropdown-item" title="Edit Album">
                                <i class="las la-pen"></i><span>Edit</span>
                            </a>
                            <a href="javascript:void(0);" data-id="{{ $item->id }}" class="dropdown-item swal-delete" title="Delete Album">
                            ...
                            <a href="javascript:void(0);" onclick="$(this).find('form').submit();" class="dropdown-item" data-original-title="Click to up position">
                                ...
                                <form action="{{ route('gallery.album.position', [$item->id, 'position' => ($item->position - 1)]) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                </form>
                            </a>
