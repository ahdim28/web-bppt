            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        @can ('gallery_category_playlist_update')
                        <a href="javascript:void(0);" onclick="$(this).find('form').submit();" class="badge badge-{{ $item->customConfig()['publish']['color'] }}"
                            ...
                            <form action="{{ route('gallery.playlist.category.publish', ['id' => $item->id]) }}" method="POST">
                                @csrf
                                @method('PUT')
                            </form>
                        </a>
                    ...
                    <td class="text-center">
                        @if (Auth::user()->can('gallery_category_playlist_update') && $item->min('position') != $item->position)
                        ...
                        @endif
                        @if (Auth::user()->can('gallery_category_playlist_update') && $item->max('position') != $item->position)
                    ...
                    <td class="text-center">
                        ...
                        @endcan
                        @can('gallery_category_playlist_delete')
