...
<div class="card mb-4">
    <h6 class="card-header">
      Form Playlist Category
    </h6>
    <form action="{{ !isset($data['category']) ? route('gallery.playlist.category.store') : route('gallery.playlist.category.update', ['id' => $data['category']->id]) }}" method="POST">
        @csrf
        @isset ($data['category'])
            @method('PUT')
        @endisset
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><strong>{{ url('/').'/video/' }}</strong></span>
                                            </div>
