...
<div class="card">
    <div class="card-header with-elements">
        <h5 class="card-header-title mt-1 mb-0">Link List</h5>
        <div class="card-header-elements ml-auto">
            @can ('link_create')
            <a href="{{ route('link.create') }}" class="btn btn-success icon-btn-only-sm" title="Add New Link">
                <i class="las la-plus"></i> <span>Link</span>
            </a>
            @endcan
        </div>
    </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        Total : <span class="badge badge-success">{{ $item->medias->count() }}</span>
                    </td>
                    ...
                    <td class="text-center">
                        ...
                        <a href="javascript:void(0);" onclick="$(this).find('form').submit();" class="badge badge-{{ $item->customConfig()['publish']['color'] }}"
                            title="Click to change status link">
                    ...
                    <td class="text-center">
                        @can('link_medias')
                        <a href="{{ route('link.media.index', ['linkId' => $item->id]) }}" class="btn btn-sm btn-warning" title="list media">
                            <i class="las la-list"></i> MEDIA
                        </a>
                        @endcan
                        <a href="{{ route('link.read.'.$item->slug) }}" class="btn icon-btn btn-sm btn-info" title="View Detail" target="_blank">
                            <i class="las la-external-link-alt"></i>
                        </a>
                        @can('link_update')
                        <a href="{{ route('link.edit', ['id' => $item->id]) }}" class="btn icon-btn btn-sm btn-primary" title="Edit Link">
                            <i class="las la-pen"></i>
                        </a>
                        @endcan
                        @can('link_delete')
                        <a href="javascript:;" data-id="{{ $item->id }}" class="btn icon-btn btn-sm btn-danger swal-delete" title="Delete Link">
                    ...
                    <td>
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="item-table">
                                    <div class="data-table">Media</div>
                                    <div class="desc-table">
                                        Total : <span class="badge badge-success">{{ $item->medias->count() }}</span><br>
                                    </div>
                                </div>
                                <div class="item-table">
    ...
    <div class="card-footer">
        <div class="row align-items-center">
            <div class="col-lg-6 m--valign-middle">
                Showing : <strong>{{ $data['links']->firstItem() }}</strong> - <strong>{{ $data['links']->lastItem() }}</strong> of
