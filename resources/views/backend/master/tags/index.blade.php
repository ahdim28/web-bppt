...
<div class="card">
    <div class="card-body">
        <div class="form-row align-items-center">
            ...
            <div class="col-md">
                <div class="form-group">
                    <label class="form-label">@lang('mod/master.tag.label.field4')</label>
...
<div class="card">
    <div class="card-header with-elements">
        <h5 class="card-header-title mt-1 mb-0">@lang('mod/master.tag.text')</h5>
        <div class="card-header-elements ml-auto">
            @can ('tag_create')
            <a href="{{ route('tag.create') }}" class="btn btn-success icon-btn-only-sm" title="@lang('lang.add_attr_new', [
                'attribute' => __('mod/master.tag.caption')
            ])"">
                <i class="las la-plus"></i> <span>@lang('mod/master.tag.caption')</span>
            </a>
            @endcan
        </div>
    </div>
        ...
        <table id="user-list" class="table card-table table-striped table-bordered table-hover">
            <thead>
                <tr>
                    ...
                    <th>@lang('mod/master.tag.label.field1')</th>
                    <th class="text-center" style="width: 150px;">@lang('mod/master.tag.label.field3')</th>
                    <th class="text-center" style="width: 150px;">@lang('mod/master.tag.label.field4')</th>
                    <th class="text-center" style="width: 80px;">@lang('mod/master.tag.use')</th>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a href="javascript:void(0);" onclick="$(this).find('form').submit();" class="badge badge-{{ $item->customConfig()['flags']['color'] }}"
                                title="@lang('mod/master.tag.label.field3')">
                        ...
                        <td class="text-center">
                            @can ('tag_update')
                            <a href="javascript:void(0);" onclick="$(this).find('form').submit();" class="badge badge-{{ $item->customConfig()['standar']['color'] }}"
                                title="@lang('mod/master.tag.label.field4')">
                                {{ __($item->customConfig()['standar']['title']) }}
                            ...
                            @else
                            <span class="badge badge-{{ $item->customConfig()['standar']['color'] }}">{{ __($item->customConfig()['standar']['title']) }}</span>
                            @endcan
                        </td>
                        <td class="text-center">
                            <span class="badge badge-info">{{ $item->type->count() }}</span>
                        </td>
                        <td>
                        ...
                        <td class="text-center">
                            @can ('tag_update')
                            <a href="{{ route('tag.edit', ['id' => $item->id]) }}" class="btn btn-primary icon-btn btn-sm" title="@lang('lang.edit_attr', [
                                'attribute' => __('mod/master.tag.caption')
                            ])">
                                <i class="las la-pen"></i>
                            </a>
                            @else
                            <button type="button" class="btn btn-primary icon-btn btn-sm" title="@lang('alert.access_denied')" disabled>
                                <i class="las la-pen"></i>
                            </button>
                            @endcan
                            @can ('tag_delete')
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="item-table">
                                    <div class="data-table">@lang('mod/master.tag.label.field1')</div>
                                    <div class="desc-table"><strong>{{ $item->name }}</strong></div>
                                </div>
                                <div class="item-table">
                                    <div class="data-table">@lang('mod/master.tag.label.field3')</div>
                                ...
                                <div class="item-table">
                                    <div class="data-table">@lang('mod/master.tag.label.field4')</div>
                                    <div class="desc-table">
                                        @can ('tag_update')
                                        <a href="javascript:void(0);" onclick="$(this).find('form').submit();" class="badge badge-{{ $item->customConfig()['standar']['color'] }}"
                                            title="@lang('mod/master.tag.label.field4')">
        ...
        $('.swal-delete').on('click', function () {
            ...
            Swal.fire({
                ...
                if (response.value.success) {
                    Swal.fire({
                        type: 'success',
                        text: "@lang('alert.delete_success', ['attribute' => __('mod/master.tag.caption')])"
                    }).then(() => {
