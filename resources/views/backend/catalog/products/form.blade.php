                                            ...
                                            <div class="col-sm-10">
                                                <select class="selectpicker custom-select" name="type_id" data-style="btn-default">
                                                    ...
                                                    @foreach ($data['types'] as $type)
                                                        <option value="{{ $type->id }}" {{ old('type_id') == $type->id ? 'selected' : '' }}>{!! $type->fieldLang('name') !!}</option>
                                                    @endforeach
                                                </select>
                                                @error('type_id')
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <label class="switcher">
                                                    <input type="checkbox" name="is_discount" id="is-discount" value="1" class="switcher-input" {{ old('is_discount') == 1 ? 'checked' : '' }}>
