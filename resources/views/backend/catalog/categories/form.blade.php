            ...
            <div class="tab-pane fade" id="setting">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control" name="product_limit" value="{{ old('product_limit') }}" placeholder="for product">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-form-label col-sm-2 text-sm-right">Product Selection</label>
                        <div class="col-sm-10">
                            <input type="number" class="form-control" name="product_selection" value="{{ old('product_selection') }}" placeholder="for product">
                        </div>
                    </div>
                    <hr>
                    <div class="form-group row">
