...
<div class="card">
    <div class="card-header with-elements">
        <h5 class="card-header-title mt-1 mb-0">Catalog Category List</h5>
        <div class="card-header-elements ml-auto">
            @can ('catalog_category_create')
            <a href="{{ route('catalog.category.create') }}" class="btn btn-success icon-btn-only-sm" title="Add New Catalog Category">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        Total : <span class="badge badge-success">0</span>
                    </td>
                    ...
                    <td class="text-center">
                        @if (Auth::user()->can('catalog_category_update') && $item->min('position') != $item->position)
                        ...
                        @endif
                        @if (Auth::user()->can('catalog_category_update') && $item->max('position') != $item->position)
                    ...
                    <td class="text-center">
                        <a href="{{ route('catalog.category.read', ['slugCategory' => $item->slug]) }}" class="btn icon-btn btn-sm btn-info" title="View Detail" target="_blank">
                            <i class="las la-external-link-alt"></i>
                        </a>
                        @can('catalog_category_update')
                        ...
                        <a href="javascript:;" data-id="{{ $item->id }}" class="btn icon-btn btn-sm btn-danger swal-delete" title="Delete Catalog Category">
                    ...
                    <td>
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="item-table">
                                    <div class="data-table">Product</div>
                                    <div class="desc-table">
                                        Total : <span class="badge badge-success">0</span>
                                    </div>
                                </div>
