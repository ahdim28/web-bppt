<nav class="layout-navbar navbar navbar-expand-lg align-items-lg-center bg-navbar-theme container-p-x" id="layout-navbar">
    ...
    <a href="{{ route('dashboard') }}" class="navbar-brand app-brand demo d-lg-none py-0 mr-0" title="@lang('mod/dashboard.title')">
        ...
        <span class="app-brand-text demo font-weight-normal ml-2">@lang('lang.backend_panel')</span>
    </a>
    ...
    <div class="navbar-collapse collapse" id="layout-navbar-collapse">
        ...
        <div class="navbar-nav align-items-lg-center d-none d-lg-block">
          ...
          <label class="nav-item navbar-text navbar-search-box p-0 active">
            ...
            <a href="{{ route('home') }}" data-toggle="tooltip" target="_blank" title="@lang('lang.view_frontend')"><i class="las la-external-link-alt"></i></a>
          </label>
        </div>
        ...
        <div class="navbar-nav align-items-lg-center ml-lg-auto">
          <div class="demo-navbar-notifications nav-item dropdown mr-lg-3" id="notif-bar">
            <a class="nav-link dropdown-toggle hide-arrow" href="#" data-toggle="dropdown" id="click-notif">
              ...
              <span class="d-lg-none align-middle">&nbsp; @lang('mod/setting.notification.title')</span>
            </a>
            <div class="dropdown-menu dropdown-menu-right">
              <div class="bg-primary text-center text-white font-weight-bold p-3" id="count-new-notif">
                @lang('mod/setting.notification.new_notif')
              </div>
              <div class="list-group list-group-flush" id="list-notification">

              </div>

              <a href="{{ route('notification') }}" class="d-block text-center text-light small p-2 my-1" title="@lang('mod/setting.notification.caption')">
                @lang('lang.view_all') @lang('mod/setting.notification.caption')
              </a>
            </div>
          </div>
          ...
          <div class="demo-navbar-user nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right">
              ...
              <a href="{{ route('profile') }}" class="dropdown-item" title="@lang('mod/users.user.profile.title')">
                <i class="las la-user-circle"></i>
                &nbsp; @lang('mod/users.user.profile.title')
              </a>
              <a href="{{ route('notification') }}" class="dropdown-item" title="@lang('mod/setting.notification.caption')">
                <i class="las la-bell"></i>
                &nbsp; @lang('mod/setting.notification.caption')
              </a>
              @can ('configurations')
              <a href="{{ route('configuration.website') }}" class="dropdown-item" title="@lang('mod/setting.config.caption')">
                <i class="las la-cog"></i>
                &nbsp; @lang('mod/setting.config.caption')
              </a>
              @endcan
              <div class="dropdown-divider"></div>
              <a href="javascript:void(0)" class="dropdown-item" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" title="@lang('auth.logout.title')">
