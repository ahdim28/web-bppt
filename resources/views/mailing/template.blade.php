...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="{{ asset('assets/images/favicon.ico') }}" sizes="32x32">
	<!--[if gte mso 9]>
...
<body class="body" style="padding:0 !important; margin:0 !important; display:block !important; min-width:100% !important; width:100% !important; background:#0084ff; -webkit-text-size-adjust:none;">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#0084ff">
		<tr>
					...
					<tr>
						<td align="center">
							<table width="650" border="0" cellspacing="0" cellpadding="0" class="mobile-shell">
													...
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															<th class="column" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;">
																<table width="100%" border="0" cellspacing="0" cellpadding="0">
																	<tr>
																		<td class="img m-center" style="font-size:0pt; line-height:0pt; text-align:left;"><img src="{{ $config['logo_mail'] }}" width="191" height="32" border="0" alt="" /></td>
																	</tr>
																</table>
															</th>
															<th class="column-empty" width="1" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;"></th>
															<th class="column" width="180" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;">
																<table width="100%" border="0" cellspacing="0" cellpadding="0">
																	<tr>
																		<td class="text-header right" style="color:#000000; font-family:'Fira Mono', Arial,sans-serif; font-size:12px; line-height:16px; text-align:right;">
                                                                            <a href="#" target="_blank" class="link" style="color:#000001; text-decoration:none;">
                                                                                <span class="link" style="color:#000001; text-decoration:none;">
                                                                                    Phone : {{ $config['phone'] }}
                                                                                </span>
                                                                            </a>
                                                                        </td>
											...
											<tr>
												<td class="footer" style="padding: 0px 30px 30px 30px;">
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														...
														<tr>
															<td class="text-socials" style="color:#000000; font-family:'Fira Mono', Arial,sans-serif; font-size:16px; line-height:22px; text-align:center; text-transform:uppercase;">Contact</td>
														</tr>
														<tr>
															<td style="padding: 30px 0px 30px 0px;" align="center">
																<table class="center" border="0" cellspacing="0" cellpadding="0" style="text-align:center;">
																	<tr>
																		{{-- <td class="img" width="150" style="font-size:10pt; line-height:0pt; text-align:left;">
                                                                            Telp : {{ $config['phone'] }}
                                                                        </td>
                                                                        <td class="img" width="150" style="font-size:10pt; line-height:0pt; text-align:left;">
                                                                            Fax : {{ $config['fax'] }}
                                                                        </td> --}}
                                                                        <td class="img" width="220" style="font-size:10pt; line-height:0pt; text-align:left;">
                                                                            Email : <a href="mailto:{{ $config['email'] }}" target="_blank">{{ $config['email'] }}</a>
                                                                        </td>
																	</tr>
																</table>
															</td>
								...
								<tr>
									<td class="text-footer" style="padding-top: 30px; color:#ffffff; font-family:'Fira Mono', Arial,sans-serif; font-size:12px; line-height:22px; text-align:center;">
										&copy; {{ now()->format('Y') }} <strong>{{ $config['website_name'] }}</strong> @lang('common.copyright') <br />
                                        <a href="#" target="_blank" class="link4" style="color:#ffffff; text-decoration:none;">
                                            <span class="link4" style="color:#ffffff; text-decoration:none;">{{ $config['address'] }}</span>
                                        </a>
									</td>
								</tr>
							</table>
